<template>
	<view class="box">
		<movable-area>
			<movable-view class="xzBox" id="xzBox" direction="all" @change="onChange"><image id="xz" class="xz" src="../../../static/p2/xz.png" mode="widthFix"></image></movable-view>
			<image id="door" class="door" src="../../../static/p2/door.png" mode="heightFix"></image>
		</movable-area>
		<button type="default" size="mini" class="btn startBtn">开启</button>
		<button type="default" size="mini" class="btn closeBtn">关闭</button>
		<view class="tit">传递舱外门</view>
		<view class="navBox">
