	...
	<view class="box">
		<movable-area>
			<movable-view style="z-index: 1;" class="xzBox" direction="all" @change="onChange">
				<image id="xz" class="xz" src="../../../static/p2/zwx.png" mode="widthFix"></image>

				<view class="time">{{ num }}</view>
				<view @click="handleJia" class="jia"></view>
				<view @click="handleJian" class="jia jian"></view>
			</movable-view>
